...
local L = AceLocale:NewLocale("SunUI", "zhCN", true)
...
do
	...
	L["跳过"] = true
	L["欢迎使用SunUI"] = true
	L["QQ群"] = "有问题可以加QQ群:180175370 我的微博http://weibo.com/sunui"
	L["更新地址"] = "永久更新地址https://git.oschina.net/Coolkid/SunUI"
end
...
do
	L["技能监视"] = true
	L["技能监视信息"] = "\n\n此模块使用RayWatch的代码 原来的技能监视有很严重的性能问题会造成游戏顿卡 故放弃使用"
end
