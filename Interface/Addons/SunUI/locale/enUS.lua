...
L["应用"] = "Accpet"
L["启用插件UI缩放设定"] = "Enable SunUI uiScale"
L["自动设定UI缩放"] = "Auto set uiScale"
L["需要开启插件UI缩放设定"] = "Need Enable SunUI uiScale"
L["锁定UI缩放"] = "Lock uiScale "
L["内置CD"] = "Internal cooldown"
L["启动内置CD"] = "Enable Internal cooldown"
...
L_TOOLTIP_INSPECT_Enable = "Inspect Frame is Enable"
--loot
...
--11.14
L["版本号:"] = "version:"
L["按键绑定"] = "Binding buttons"
L["经验条宽度"] = "expbar width"
L["经验条高度"] = "expbar height"
L["经验条垂直模式"] = "expbar vertical"
L["经验条渐隐"] = "fadeout expbar"
L["全部动作条渐隐"] = "fadeout all ActionBar"
L["Bar1渐隐"] = "fadeout Bar1"
L["Bar2渐隐"] = "fadeout Bar2"
L["Bar3渐隐"] = "fadeout Bar3"
L["Bar4渐隐"] = "fadeout Bar4"
L["Bar5渐隐"] = "fadeout Bar5"
L["姿态栏渐隐"] = "fadeout StanceBar"
L["宠物渐隐"] = "fadeout PetBar"
L["Big1大小"] = "Big1 Button Size"
L["Big2大小"] = "Big2 Button Size"
L["Big3大小"] = "Big3 Button Size"
L["Big4大小"] = "Big4 Button Size"
L["启用脱离战斗隐藏"] = "fadeout when leave combat"
L["焦点放大"] = "big focus"
L["施法条开关"] = "Enable SunUI CastBar"
L["距离监视"] = "range"
L["超过40码头像渐隐"] = "over 40 yard oor"
L["距离监视透明度"] = "range alpha"
L["超出距离头像透明度"] = "over range alpha"
L["焦点debuff过滤"] = "focus debuff"
L["只显示玩家释放的debuff"] = "only player debuff"
L["头像文字渐隐"] = "fadeout Tags"
L["非战斗非指向时隐藏"] = "fadeout UnitFrame"
L["血条非透明模式"] = "Normal UnitFrame Mode"
L["不打钩为透明模式"] = "不打钩为透明模式"
L["小队头像"] = "Party Portrait"
L["开启复仇监视"] = "VengeanceBar"
L["开启仇恨监视"] = "ThreatBar"
L["玩家框体BUFF显示"] = "player BUFF"
L["副本排队助手"] = "LFR assistant"
L["隐藏暴雪团队框架"] = "Hide Blz RaidFrame"
L["快速分解"] = "Quick Disenchat"
L["自动接受复活"] = "Auto Accept Resurret"
L["AFK锁屏"] = "AFK Frame"
L["自动交接任务"] = "Auto Quest"
L["过滤DND/AFK自动回复消息"] = "Filter DND/AFK message"
L["聊天时间戳"] = "TimeStamps"
L["聊天框背景"] = "Chat Frame Background "
L["战斗提醒"] = "Combat Message"
L["进出战斗提醒"] = "Combat Message"
L["Aurora主题"] = "Aurora Theme"
L["透明模式"] = "Aurora mode"
L["显示未探索地区"] = "Shows unexplored areas of zone maps"
L["启用图标模式"] = "Icon Modde"
L["职业能量条"] = "Class PowerBar"
L["启用职业能量条"] = "Enable"
L["渐隐"] = "Fade when leave combat"
L["生命值"] = "Health and Power"
L["警告提示"] = "Waring"
L["启用警告提示"] = "Enable"
L["低血量"] = "Low Health"
L["开启低血量报警"] = "Enable Low Health"
L["施法通告"] = "Announce"
L["启用施法通告"] = "Enable Announce"
L["只是通告自己施放的法术"] = "Only Announce you cast"
L["启用打断通告"] = "Enable Interrupt"
L["启用治疗大招通告"] = "Enable Health Spell"
L["启用误导通告"] = "Enable Mislead Spell"
L["启用保命技能通告"] = "Enable Tank Spell"
L["启用给出大招通告"] = "Enable long CD Spell"
L["包含天使,痛苦压制,保护等等"] = "包含天使,痛苦压制,保护等等"
L["启用复活技能通告"] = "Enable long CD Spell"
L["启用团队减伤通告"] = "Enable Raid Spell"
L["启用队友施法通告"] = "Enable Raid Member Cast Spell Announce"
L["背包图标"] = "Bag Icon Size"
L["银行图标"] = "Bank Icon Size"
L["图标间距"] = "Space"
L["背包框体宽度"] = "Bag width"
L["银行框体宽度"] = "Bank width"
L["自动换装"] = "Equipment manage"
L["启用自动换装"] = "Enable"
L["选择主天赋装备"] = "First Talent"
L["选择副天赋装备"] = "Second talent"
L["战斗中无法打开控制台"] = "Cannt open in Combat"
L["改变参数需重载应用设置"] = "Need Reload to change set"
L["结束"] = "Finish"
L["下一步"] = "Next"
L["跳过"] = "ignore"
L["安装"] = "Install"
...
L["非暴雪插件总计"] = "user UI"
L["一共占用"] = "total"
L["回收内存"] = "|cffeda55fGarbage Collection"
L["目前"] = "New"
L["收入"] = "income"
L["花费"] = "cost"
L["亏损"] = "loss"
...
L["隐藏伤害统计"] = "Hide Numeration"
L["暂时不兼容其他伤害统计"] = "暂时不兼容其他伤害统计"
L["欢迎使用"] = "Welcome to SunUI"
L["个人主页"] = "personal homepage"
L["您现在处于"] = "You are"
L["状态"] = ""
L["点我解锁"] = "click me unlock"
L["星期天"] = "Sunday"
L["星期一"] = "Monday "
L["星期二"] = "Tuesday"
L["星期三"] = "Wednesday"
