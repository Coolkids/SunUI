...
function AL:Init()
	...
	altztop.clock:SetFont(DB.Font, 20*SunUIConfig.db.profile.MiniDB.FontScale, "NONE")
	...
	altztop.date:SetFont(DB.Font, 17*SunUIConfig.db.profile.MiniDB.FontScale, "NONE")
	...
	altztop.text:SetFont(DB.Font, 30*SunUIConfig.db.profile.MiniDB.FontScale, "NONE")
	...
	altztop.logo:SetFont(DB.Font, 12*SunUIConfig.db.profile.MiniDB.FontScale, "NONE")
	...
	altztop.url:SetFont(DB.Font, 12*SunUIConfig.db.profile.MiniDB.FontScale, "NONE")
	...
	altztop.afk:SetFont(DB.Font, 24*SunUIConfig.db.profile.MiniDB.FontScale, "NONE")
	...
	altztop.text2:SetFont(DB.Font, 12*SunUIConfig.db.profile.MiniDB.FontScale, "NONE")
