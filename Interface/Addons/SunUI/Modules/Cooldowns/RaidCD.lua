...
local raid_spells = DB.DateBase.RaidCD
...
local CreateBar = function()
	...
	bar.left:SetSize(C["RaidCDWidth"]*2/3, C["RaidCDHeight"])
	...
	bar.icon:SetWidth(C["RaidCDHeight"]*2)
	bar.icon:SetHeight(C["RaidCDHeight"]*2)
