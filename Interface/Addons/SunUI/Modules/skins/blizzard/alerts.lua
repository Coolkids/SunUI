			...
			if frame then
                ...
                if not frame.bg then
					...
					if not _G["AchievementAlertFrame"..i.."IconTexture"].b then
						_G["AchievementAlertFrame"..i.."IconTexture"].b = A:CreateBG(_G["AchievementAlertFrame"..i.."IconTexture"])
					end
		...
		if frame then
			...
			if not frame.bg then
				...
				if not ChallengeModeAlertFrame1DungeonTexture.b then
					ChallengeModeAlertFrame1DungeonTexture.b = A:CreateBG(ChallengeModeAlertFrame1DungeonTexture)
				end
		...
		if frame then
			...
			if not frame.bg then
				...
				if not ScenarioAlertFrame1DungeonTexture.b then
					...
					A:CreateBD(ScenarioAlertFrame1DungeonTexture.b, 0)
				end
