...
local function LoadSkin()
	...
	if not(IsAddOnLoaded("Butsu") or IsAddOnLoaded("LovelyLoot") or IsAddOnLoaded("XLoot")) then
		...
		local function CreateLootSlot(self, id)
			...
			slot.text:SetFont(S["media"].font, S["media"].fontsize, S["media"].fontflag)
			...
			slot.count:SetFont(S["media"].font, S["media"].fontsize, S["media"].fontflag)
		...
		loot.title:SetFont(S["media"].font, S["media"].fontsize, S["media"].fontflag)
		...
		for i = 1, #chn do
			...
			loot.announce[i]:SetBackdropBorderColor(unpack(S["media"].bordercolor))
