...
local function LoadSkin()
    ...
    A:ReskinPortraitFrame(TradeFrame, true)
	for i = 3, 6 do
		select(i, TradeFrame:GetRegions()):Hide()
	end
	A:Reskin(TradeFrameTradeButton)
	A:Reskin(TradeFrameCancelButton)
	...
	A:ReskinInput(TradePlayerInputMoneyFrameGold)
	A:ReskinInput(TradePlayerInputMoneyFrameSilver)
	...
	A:ReskinInput(TradePlayerInputMoneyFrameCopper)
