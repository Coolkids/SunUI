...
local function LoadSkin()
	A:ReskinPortraitFrame(ItemSocketingFrame, true)
	A:CreateBD(ItemSocketingScrollFrame, .25)
	...
	A:Reskin(ItemSocketingSocketButton)
	A:ReskinClose(ItemSocketingCloseButton, "TOPRIGHT", ItemSocketingFrame, "TOPRIGHT", -6, -12)
	A:ReskinScroll(ItemSocketingScrollFrameScrollBar)
...
A:RegisterSkin("Blizzard_ItemSocketingUI", LoadSkin)