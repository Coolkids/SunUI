...
local function LoadSkin()
	...
	A:Reskin(ReforgingFrameRestoreButton)
	A:Reskin(ReforgingFrameReforgeButton)
	A:ReskinClose(ReforgingFrameCloseButton)
	...
	A:CreateBD(ReforgingFrame.ItemButton, .25)
...
A:RegisterSkin("Blizzard_ReforgingUI", LoadSkin)