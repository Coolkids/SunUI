...
local function LoadSkin()
	...
	A:CreateBD(ItemUpgradeFrame.ItemButton, .25)
	...
	A:ReskinPortraitFrame(ItemUpgradeFrame)
	A:Reskin(ItemUpgradeFrameUpgradeButton)
end

A:RegisterSkin("Blizzard_ItemUpgradeUI", LoadSkin)
