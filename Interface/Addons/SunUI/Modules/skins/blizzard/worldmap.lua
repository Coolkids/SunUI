...
local function LoadSkin()
	...
	A:SetBD(BorderFrame, 1, 0, -3, 2)
	A:ReskinClose(BorderFrame.CloseButton)
	A:ReskinArrow(WorldMapFrame.UIElementsFrame.CloseQuestPanelButton, "left")
	A:ReskinArrow(WorldMapFrame.UIElementsFrame.OpenQuestPanelButton, "right")
	A:ReskinDropDown(WorldMapLevelDropDown)
	A:ReskinNavBar(WorldMapFrameNavBar)
