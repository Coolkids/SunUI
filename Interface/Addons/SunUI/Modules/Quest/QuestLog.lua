...
local function QQI_ParseQuestLog()
...
local function QQI_ParseTooltip()
...
local function QQI_MacroFinder()
...
local function QQI_CreateMacro()
...
local function QQI_MacroUpdater(macroSlot,itemName)
