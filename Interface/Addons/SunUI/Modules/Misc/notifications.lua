...
local N = LibStub("AceAddon-3.0"):GetAddon("SunUI"):NewModule("Notification", "AceEvent-3.0", "AceHook-3.0")
...
function N:OnInitialize()
	...
	MoveHandle.Notification = S.MakeMoveHandle(f, "事件通知", "Notification")
	self:UpdateSet()
end