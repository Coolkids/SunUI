...
function B:CreateRaidCheck()
	local A = S:GetModule("Skins")
	local RaidCheckFrameLeft = CreateFrame("Button", "RaidCheckFrameLeft",  CollectorButton)
	RaidCheckFrameLeft:SetSize(15, 15)
	RaidCheckFrameLeft:SetPoint("TOPRIGHT",  CollectorButton, "TOPRIGHT", -5, -5)
	RaidCheckFrameLeft.text = RaidCheckFrameLeft:CreateFontString(nil, 'OVERLAY')
	RaidCheckFrameLeft.text:SetFont(S["media"].font, S["media"].fontsize-2, "THINOUTLINE")
	RaidCheckFrameLeft.text:SetPoint("CENTER")
	...
	local RaidCheckFrameRight = CreateFrame("Button", "RaidCheckFrameRight",  CollectorButton)
	...
	RaidCheckFrameRight.text:SetFont(S["media"].font, S["media"].fontsize-2, "THINOUTLINE")
	RaidCheckFrameRight.text:SetPoint("CENTER")
