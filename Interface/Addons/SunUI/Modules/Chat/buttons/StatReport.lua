...
function B:CreateStatReport()
	local A = S:GetModule("Skins")
	local statreport = CreateFrame("Button", "ButtonST", CollectorButton)
	statreport:SetSize(15, 15)
	statreport:SetPoint("TOPLEFT", CollectorButton, "TOPLEFT", 5, -45)
	statreport.text = statreport:CreateFontString(nil, 'OVERLAY')
	statreport.text:SetFont(S["media"].font, S["media"].fontsize-2, "THINOUTLINE")
	statreport.text:SetPoint("CENTER")
	statreport.text:SetText("ST")
	statreport.text:SetTextColor(23/255, 132/255, 209/255)

	statreport:SetScript("OnMouseUp", function(self) B:SendReport() end)
