...
if not ct.blizzheadnumbers then
	...
	fsTitle:f:SetShadowColor(0, 0, 0, 1)		
	...
	fsVersion:f:SetShadowColor(0, 0, 0, 1)
...
local StartConfigmode = function()
    if not InCombatLockdown() then
        for i = 1, #ct.frames do
			...
			f.fsp:f:SetShadowColor(0, 0, 0, 1)		
			...
			f.fsw:f:SetShadowColor(0, 0, 0, 1)
			...
			f.fsh:f:SetShadowColor(0, 0, 0, 1)		
