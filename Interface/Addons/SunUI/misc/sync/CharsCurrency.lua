...
frame:SetScript("OnEvent", function(self, event, addon)
        if event == "ADDON_LOADED" then
                ...
                if not S.global then S.global = {} end
				if not S.global.SavedCurrency then S.global.SavedCurrency = {} end
                if not S.global.SavedCurrency[myPlayerRealm] then S.global.SavedCurrency[myPlayerRealm] = {} end
                ...
                realmDB = S.global.SavedCurrency[myPlayerRealm][faction]
