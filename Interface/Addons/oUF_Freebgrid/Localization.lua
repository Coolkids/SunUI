...
ns.Locale = (GetLocale() == "zhCN") and {
	...
	ClickCast = "点击施法",
	ClickCastenable = "启用",
	ClickCastenabledesc = "启用点击施法,可以在下面设置相关技能和按键绑定.",
	ClickCastSetDefault = "恢复默认",
	ClickCastSetDefaultdesc = "恢复点击施法设置为默认.",
	ClickCastapply = "应用更改",
	...
	fontoptsIsNotConnected = "离线单位淡出显示.",
	...
	miscoptshideraiddesc = "关闭/显示wow自带团队框架,不可在战斗中使用,重启生效.",
	miscoptsparty = "小队时显示",
	...
	miscoptsdispel = "可驱散buff显示方式",
	miscoptsindicator = "边角指示器尺寸",
...
or (GetLocale() == "zhTW") and {
	...
	ClickCast = "點擊施法",
	ClickCastenable = "啟用",
	ClickCastenabledesc = "啟用點擊施法,可以在下面設置相關技能和按鍵綁定.",
	ClickCastSetDefault = "恢復默認",
	ClickCastSetDefaultdesc = "點擊施法設置為默認狀態.",
	ClickCastapply = "應用更改",
	...
	fontoptsIsNotConnected = "離綫單位淡出顯示.",
	...
	miscoptshideraiddesc = "關閉/顯示魔獸自帶團隊插件,不可在戰鬥中使用,重啟生效.",
	miscoptsparty = "小隊時顯示",
	miscoptssolo = "單人時顯示",
	...
	miscoptsdispel = "可驅散buff顯示方式",
	miscoptsindicator = "邊角指示器尺寸",
