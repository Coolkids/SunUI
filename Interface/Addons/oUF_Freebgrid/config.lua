...
local dispeltext = {
	...
	["INDICATOR"]	= L.dispeltextindicator,
}
local macroedit = {
	hidden = true,
	path = nil,
...
local generalopts = {
    ...
    args = {
        ...
        width = {
            ...
            set = function(info,val) ns.db.width = val; wipe(ns.nameCache); ns.updateFrameSetting() end,
        },
        height = {
            ...
            set = function(info,val) ns.db.height = val;ns.updateFrameSetting() end,
        },
        spacing = {
...
local miscopts = {
    ...
    args = {
		...
		tankaura = {
            name = L.miscoptstankaura,
            type = "toggle",
            order = 17,
            desc = L.miscoptstankauradesc,
