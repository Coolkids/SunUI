...
local function updateFonts(object)
	...
	object.Indicators.TL:SetFont(indicator, ns.db.indicatorsize, "THINOUTLINE")
    object.Indicators.TR:SetFont(indicator, ns.db.indicatorsize, "THINOUTLINE")
    object.Indicators.BL:SetFont(indicator, ns.db.indicatorsize, "THINOUTLINE")
	object.Indicators.RC:SetFont(indicator, ns.db.indicatorsize, "THINOUTLINE")
    object.Indicators.Cen:SetFont(symbols, ns.db.fontsizeEdge, ns.db.outline) 
