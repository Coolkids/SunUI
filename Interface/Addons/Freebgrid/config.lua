...
local function updateFonts(object)
	...
	object.Indicators.TL:SetFont(indicator, ns.db.indicatorsize, "OUTLINE")
    object.Indicators.TR:SetFont(indicator, ns.db.indicatorsize, "OUTLINE")
    object.Indicators.BL:SetFont(indicator, ns.db.indicatorsize, "OUTLINE")
	object.Indicators.RC:SetFont(indicator, ns.db.indicatorsize, "OUTLINE")
    object.Indicators.Cen:SetFont(symbols, ns.db.fontsizeEdge, "OUTLINE") 
	object.Indicators.Cen:SetWidth(ns.db.width)
	object.Indicators.BR:SetFont(symbols, ns.db.symbolsize, "OUTLINE")
end
...
function ns:UpdateObjectLayout()
    ...
    for _, object in next, ns._Objects do
		...
		ns:UpdatePowerBarLayout(object)
