...
local CB = LibStub("AceAddon-3.0"):GetAddon("Core"):NewModule("CB", "AceTimer-3.0")
function CB:OnInitialize()
local Module = LibStub("AceAddon-3.0"):GetAddon("Core"):GetModule("SunUIConfig", "AceConsole-3.0")
