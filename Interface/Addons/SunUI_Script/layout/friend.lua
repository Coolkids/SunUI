...
local Module = Core:NewModule("InfoPanelfriend")
function Module:OnEnable()
	if C["InfoPanelDB"]["Friend"] ~= true or C["InfoPanelDB"]["OpenBottom"] ~= true then return end
...
Text:SetPoint("LEFT", BottomBar, "LEFT", 190, 2)
