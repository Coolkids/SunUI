...
local Module = Core:NewModule("InfoPanelguild")

function Module:OnEnable()
	if C["InfoPanelDB"]["Guild"] ~= true or C["InfoPanelDB"]["OpenBottom"] ~= true then return end
...
Text:SetPoint("LEFT", BottomBar, "LEFT", 270, 2)
