function Hook_FriendsList_Update()
	...
	if numBNetOnline > 0 then
		for i=1, numBNetOnline, 1 do
			local presenceID, givenName, surname, toonName, toonID, client, isOnline, lastOnline, isAFK, isDND, messageText, noteText = BNGetFriendInfo(i);
			if client == BNET_CLIENT_WOW then
				...
				if nameString then
					nameString:SetText(surname.." "..givenName.." ("..toonName..", L"..level..")");
