...
local function CreateAuraIcon(parent)
	...
	button.text:SetFont(DB.PFont, 10, "OUTLINEMONOCHROME")
	button.text:SetShadowColor(0, 0, 0, 0)

	button.count = button:CreateFontString(nil,"OVERLAY")
	button.count:SetFont(DB.PFont, 9, "OUTLINEMONOCHROME")
...
local function SkinObjects(frame)
	...
	hp.value:SetFont(DB.PFont, FONTSIZE, "THINOUTLINEMONOCHROME")
	...
	cb.time:SetFont(DB.PFont, FONTSIZE, "OUTLINEMONOCHROME")
