...
local Chat = E:GetModule("Chat-SunUI")
local IconSize = 23				 -- 表情IconSize
local fdir = "Interface\\Addons\\ElvUI_SunUI_Module\\media\\Icon\\"			 -- 表情材质路径
----------------------------------------------------------------------------------------
...
function Chat:AddMessageFilter()
...
function Chat:CreateEmoteTableFrame()
	local A = E:GetModule("Skins-SunUI")
	local button = CreateFrame("Button", "ButtonE", CollectorButton)
	button:SetPoint("TOPLEFT", CollectorButton, "TOPLEFT", 5, -5)
