...
ns.watchers ={
	["DEATHKNIGHT"] = { 		--[死骑]
		{
			...
			direction = "LEFT",
			size = 28,
			setpoint = {unpack(P["filger_position"].playerbuff)},
			mode = "ICON",
		...
		},
		{
			...
			direction = "RIGHT",
			size = 28,
			setpoint = {unpack(P["filger_position"].targetdebuff)},
			mode = "ICON",
		...
		},
		{
			...
			direction = "LEFT",
			size = 28,
			setpoint = {unpack(P["filger_position"].playercd)},
			mode = "ICON",
	...
	["ALL"] = {
		{ 
			...
			direction = "LEFT",
			size = 28,
			setpoint = {unpack(P["filger_position"].enbuff)},
			mode = "ICON",
		...
		{ 
			...
			direction = "RIGHT",
			size = 40,
			setpoint = {unpack(P["filger_position"].imbuff)},
			mode = "ICON",
		...
		{ 
			...
			direction = "RIGHT",
			size = 40,
			setpoint = {unpack(P["filger_position"].pvpdebuff)},
			mode = "ICON",
		...
		{ 
			...
			direction = "RIGHT",
			size = 40,
			setpoint = {unpack(P["filger_position"].alldebuff)},
			mode = "ICON",
