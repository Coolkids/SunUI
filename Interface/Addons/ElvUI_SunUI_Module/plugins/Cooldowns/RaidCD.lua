...
local RCD = E:NewModule("RaidCD", "AceEvent-3.0", "AceHook-3.0", "AceConsole-3.0")
RCD.modName = "团队CD监视"
RCD.order = 19
...
function RCD:Initialize()
	...
	E:CreateMover(RaidCDAnchor, "RaidCDAnchorMover", "团队CD监视", true, nil, "ALL")
end
