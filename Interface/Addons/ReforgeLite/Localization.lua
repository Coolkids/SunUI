...
--   L["Please press Compute button to update the reforge."] = ""
  ...
  L["ReforgeLite failed to compute your optimal reforge. Try increasing the speed by moving the speed slider.\\nError message: %s"] = "ReforgeLite ha fallito nel computare un reforgiamento ottimale. Provare a incrementare la velocita' spostando lo scorrevole. \\n Messaggio di errore: %s" -- Needs review
  L["Reforging window must be open"] = "La finestra di reforgiatura deve essere aperta"
  L["Remove line"] = "Rimuovi cap" -- Needs review
  L["Reset"] = "Reimposta"
  L["Restore"] = "Rigenera"
  L["Result"] = "Risultato"
  L["Save"] = "Salva"
