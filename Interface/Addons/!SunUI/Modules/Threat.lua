...
local function Init()
	...
	for i=1, C["ThreatLimited"] do 
		...
		StatusBar.Flag:Size(1, 2)
		StatusBar.Flag:SetVertexColor(0, 0, 0)
		StatusBar.Flag:Point("LEFT", StatusBar:GetStatusBarTexture(), "RIGHT", 0, 0)
...
Event:SetScript("OnEvent", function(self, event, ...)
	if event == "PLAYER_ENTERING_WORLD" then
		Init()
		MoveHandle.Threat = S.MakeMoveHandle(MainFrame, L["仇恨监视"], "Threat")
