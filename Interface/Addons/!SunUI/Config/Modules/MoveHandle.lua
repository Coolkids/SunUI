...
function Module.LoadSettings()
	local Default = {
		...
		["bar2"] = {"BOTTOMRIGHT", "SunUIActionBar1", "BOTTOMLEFT", -5, 0},
		["bar3"] = {"BOTTOMLEFT", "SunUIActionBar1", "BOTTOMRIGHT", 5, 0}, 
		["bar4"] = {"RIGHT", "UIParent", "RIGHT", -10, 0 }, 
		["bar5"] = {"RIGHT", "UIParent", "RIGHT", -38, 0 }, 
		["stancebar"] = {"BOTTOMLEFT", "SunUIActionBar2", "TOPLEFT", 0, 5}, 
		["petbar"] = {"BOTTOMRIGHT", "SunUIActionBar3", "TOPRIGHT", 0, 5}, 
