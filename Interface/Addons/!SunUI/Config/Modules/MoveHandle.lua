...
function Module.LoadSettings()
	local Default = {
		...
		["bar3"] = {"BOTTOM", "SunUIActionBar2", "TOP", 0, 5}, 
		["bar4"] = {"RIGHT", "UIParent", "RIGHT", -10, 0 }, 
		["bar5"] = {"RIGHT", "UIParent", "RIGHT", -38, 0 }, 
		["stancebar"] = {"BOTTOMLEFT", "MultiBarBottomRightButton6", "TOPLEFT", 0, 5}, 
		["petbar"] = {"BOTTOMRIGHT", "MultiBarBottomRightButton12", "TOPRIGHT", 0, 5}, 
