...
function Module.LoadSettings()
	local Default = {
		...
		["Combatpoint"] = {"CENTER", "UIParent", "CENTER", 0, 0},
		...
		["bar2"] = {"BOTTOM", "SunUIActionBar1", "TOP", 0, 1},
		["bar3"] = {"BOTTOMRIGHT", "SunUIActionBar1", "BOTTOMLEFT", -1, 0}, 
		["bar32"] = {"BOTTOMLEFT", "SunUIActionBar1", "BOTTOMRIGHT", 1, 0}, 
		["bar4"] = {"RIGHT", "UIParent", "RIGHT", -10, 0 }, 
		["bar51"] = {"BOTTOM", "MultiBarBottomLeftButton4", "TOP", 0, 1}, 
		["bar52"] = {"BOTTOM", "MultiBarBottomLeftButton5", "TOP", 0, 1 }, 
		["bar53"] = {"BOTTOMRIGHT", "MultiBarBottomRightButton3", "BOTTOMLEFT", -1, 0 }, 
		["bar54"] = {"BOTTOMLEFT", "MultiBarBottomRightButton9", "BOTTOMRIGHT", 1, 0 }, 
		["bar5"] = {"CENTER", "UIParent", "CENTER", 0, 0 }, 
		["stancebar"] = {"BOTTOMLEFT", "MultiBarBottomRightButton6", "TOPLEFT", 0, 1}, 
		["petbar"] = {"BOTTOMRIGHT", "MultiBarBottomRightButton12", "TOPRIGHT", 0, 1}, 
		...
		["FocusFrame"] = {"RIGHT", "UIParent", "RIGHT", -55, -95},
