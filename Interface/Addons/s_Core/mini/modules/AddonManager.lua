...
local function UpdateAddonButton(MainFrame)
	...
	for i = Start, End do
		...
		Button.Text = S.MakeFontString(Button, 13)
...
local function BuildMainFrame()
	...
	Tittle.Text = S.MakeFontString(Tittle, 14)
	...
	Reload.Text = S.MakeFontString(Reload, 12)
	...
	Bottom.Text = S.MakeFontString(Bottom, 12)
	...
	Pre.Text = S.MakeFontString(Pre, 13)
	Pre.Text:SetText("<")
	...
	Next.Text = S.MakeFontString(Next, 13)
	Next.Text:SetText(">")
