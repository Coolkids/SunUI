...
local function update(self, event, unit)
	...
	if(not pending(self, self.unit)) then
		...
		UIFrameFadeOut(rABS_MultiBarRight, 1.5, rABS_MultiBarRight:GetAlpha(), self.BarFaderMinAlpha or 0)
		...
		if DB.MyClass == "SHAMAN" then
		UIFrameFadeIn(rABS_TotemBar, 0.8, rABS_TotemBar:GetAlpha(), self.BarFaderMaxAlpha or 1)
		end
	end
end
