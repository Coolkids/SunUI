...
L["寻求组队"] = "[寻求组队]" --LookingForGroup
L["工会招募"] = "[工会招募]" --GuildRecruitment
L["战场"] = "[战场]" --Battleground
L["战场领袖"] = "[战场领袖]" --Battleground Leader
L["工会"] = "[工会]" --Guild
L["小队"] = "[小队]" --Party
L["小队队长"] = "[小队队长]" --Party Leader
L["地城领袖"] = "[地城领袖]" --Party Leader (Guide)
L["官员"] = "[官员]" --Officer
L["团队"] = "[团队]" --Raid
L["团队领袖"] = "[团队领袖]" --Raid Leader
L["团队警告"] = "[团队警告]" --Raid Warning
--staddonmanage
L["Search"] = "搜索"
L["ReloadUI"] = "重载介面"
L["Profiles"] = "配置文件"
